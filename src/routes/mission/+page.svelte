...
<!-- SRON Academy Logo -->
          ...
          <nav>
            <div class="nav-section">
              ...
              <a href="/scientific" class="nav-link">Scientific</a>
              <a href="/news" class="nav-link">News</a>
              <a href="/team" class="nav-link">Team</a>
              <a href="/careers" class="nav-link highlight">Careers</a>
            </div>
            <div class="nav-divider">
              <a href="/partners" class="nav-link">Partners</a>
              <a href="/privacy" class="nav-link highlight">Privacy</a>
            </div>
          </nav>
        </div>
        ...
        <div class="right-column">
          ...
          <div class="bottom-section">
            ...
            <div class="social-icons">
              ...
              <a href="https://bsky.app" target="_blank" rel="noopener noreferrer" class="social-link" aria-label="Bluesky">
                <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
